...
function userArea() {
    ...
    do {
        ...
        searchPriceOK = false;
        do {
            searchParam = prompt(`Introduzca el criterio de búsqueda:\n   <  menor que\n   >  mayor que\n   =  igual a`);
            if (searchParam === '<' || searchParam === '>' || searchParam === '=') {
                searchParamOK = true;
            } else {
        ...
        do {
            searchPrice = prompt(`Introduzca el precio del vuelo:`);
            if ((patt.test(searchPrice) === false) || (searchPrice === null)) {
        ...
        switch (searchParam) {
            case '<':
                ...
                for (let i=0; i<userFlights.length; i++){
                    if (userFlights[i].cost >= searchPrice) {
            ...
            case '=':
                userFlights.sort(function(a, b){return a.cost - b.cost})
                for (let i=0; i<userFlights.length; i++){
                    if (userFlights[i].cost !== parseInt(searchPrice)) {
                        userFlights.splice(i,1);
                        i=-1;
                    }
                }
        ...
        if (userFlights.length>=1) {
            ...
            do {                
                ...
                if (searchID !== null) {
                    for (let i=0; i<userFlights.length; i++) {
                        if (parseInt(searchID) === userFlights[i].id) {
                            console.log(`Ha comprado el vuelo con ID ${userFlights[i].id}.\nGracias por su compra. Vuelva pronto.`);
                            checkOperation = true;
                        }
                    }
                } else {
...
function getScale (flights, iterator) {
