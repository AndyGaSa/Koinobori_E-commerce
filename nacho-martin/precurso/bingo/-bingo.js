...
function rules() { //Las reglas se explican mediantes distintos alerts
    const welcome = alert(`¡Hola, ${user.player}! A continuación jugarás una partida de bingo.`);
    const rules1 = alert('Para empezar, se te ofrecerá un cartón con 15 números entre el 1 y el 100. ' +
        'Si no te gustan esos números, podrás elegir un nuevo cartón con 15 números nuevos.')
    const rules2 = alert('En cada turno saldrá un número. Si está en tu cartón, se tachará. ' +
    ...
    const rules3 = alert('Empezarás con una puntuación de 100 puntos, por cada número que salga que no tengas, perderás 1 punto. ' +
