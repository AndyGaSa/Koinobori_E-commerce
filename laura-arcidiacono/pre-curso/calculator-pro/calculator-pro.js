...
function calculatorPro() {
    ...
    /*Declaro una funcion que despliega una ventana emergente que le pregunta al usuario si quiere realizar calculos, y retorna un valor booleano.*/
    function confirmacionInicioDelJuego() {
        let booleanConfirmacionInicioDelJuego = window.confirm("¿Quieres hacer cálculos con Calculator-PRO?");
        return booleanConfirmacionInicioDelJuego
    }

    /*Declaro una funcion que le pregunta al usuario si quiere seguir realizando calculos una vez que ya se ha realizado el primer calculo con los datos que ha ingresado.*/
    function continuarEnElJuego() {
        let booleanContinuarEnElJuego = window.confirm("¿Quieres seguir realizando cálculos?");
        return booleanContinuarEnElJuego
    }

    /*Aquí se comienza a ejecutar el código: 
    Declaro una variable let que apunta al valor de la funcion confirmacionInicioDeljuego*/
    let quieresJugar = confirmacionInicioDelJuego();

    /*Inicio un ciclo while que se repetirá mientras la variable let quieresJugar es === true. 
    En ese caso, se declaran las variables let primerNumero, segundoNumero y arrayConResultadoDeOperaciones.*/
    while (quieresJugar) {
        let primerNumero = obtenerPrimerNumero();
        let segundoNumero = obtenerSegundoNumero();
        let arrayConResultadoDeOperaciones = [];

        /*Declaro un condicional que evalua si segundoNumero no es null.
        ...
        if (segundoNumero !== null) {
            ...
            arrayConResultadoDeOperaciones.push(`\r\nEl resultado de la resta de ${primerNumero} menos ${segundoNumero} es igual a ${calcularResta(primerNumero, segundoNumero)}.`);
            arrayConResultadoDeOperaciones.push(`\r\nEl resultado de la multiplicación de ${primerNumero} por ${segundoNumero} es igual a ${calcularMultiplicacion(primerNumero, segundoNumero)}.`);
            arrayConResultadoDeOperaciones.push(`\r\nEl resultado de la división de ${primerNumero} por ${segundoNumero} es igual a ${calcularDivision(primerNumero, segundoNumero)}.`);
            window.alert(arrayConResultadoDeOperaciones);
        }
        ...
        /*Se envia a imprimir a consola el valor de las variables let primerNumero, segundoNumero y arrayConResultadoDeOperaciones.*/
        console.log(primerNumero);
        console.log(segundoNumero);
        console.log(arrayConResultadoDeOperaciones);

        quieresJugar = continuarEnElJuego(); //Se le asigna a la variable let quieresJugar el valor retornado por al funcion continuarEnElJuego.
    }

    console.log("Hasta la próxima!");
    window.alert("Adios, vuelve a realizar cálculos cuando quieras!");
};