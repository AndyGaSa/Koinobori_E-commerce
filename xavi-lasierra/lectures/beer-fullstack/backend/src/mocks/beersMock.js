module.exports = [{
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 69, unit: 'celsius' }, duration: null }], fermentation: { temp: { value: 18, unit: 'celsius' } }, twist: null },
  ingredients: {
    ...
    hops: [{
      name: 'Amarillo', amount: { value: 13.8, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Simcoe', amount: { value: 13.8, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Amarillo', amount: { value: 26.3, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      name: 'Motueka', amount: { value: 18.8, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  ...
  ingredients: {
    malt: [{ name: 'Propino Pale Malt', amount: { value: 1.63, unit: 'kilograms' } }, { name: 'Wheat Malt', amount: { value: 1.63, unit: 'kilograms' } }, { name: 'Propino Pale Malt for kettle souring', amount: { value: 0.03, unit: 'kilograms' } }, { name: 'Acidulated Malt for kettle souring', amount: { value: 0.03, unit: 'kilograms' } }],
    hops: [{
      name: 'Bramling Cross', amount: { value: 10, unit: 'grams' }, add: 'middle', attribute: 'bitter'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: null }], fermentation: { temp: { value: 9, unit: 'celsius' } }, twist: null },
  ingredients: {
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 66, unit: 'celsius' }, duration: 70 }], fermentation: { temp: { value: 10, unit: 'celsius' } }, twist: null },
  ingredients: {
    malt: [{ name: 'Lager Malt', amount: { value: 6.63, unit: 'kilograms' } }, { name: 'Wheat', amount: { value: 0.38, unit: 'kilograms' } }],
    hops: [{
      name: 'Saaz', amount: { value: 60, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Saaz', amount: { value: 60, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Saaz', amount: { value: 60, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }],
    yeast: 'Wyeast 2007 - Pilsen Lager™'
  },
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: 75 }], fermentation: { temp: { value: 22, unit: 'celsius' } }, twist: 'Honey: 62.5g at End (WP), Coriander Seeds: 8.5g at 45mins' },
  ingredients: {
    malt: [{ name: 'Extra Pale', amount: { value: 3.63, unit: 'kilograms' } }, { name: 'Munich', amount: { value: 0.13, unit: 'kilograms' } }, { name: 'Wheat', amount: { value: 0.25, unit: 'kilograms' } }],
    hops: [{
      name: 'Amarillo', amount: { value: 2.5, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Nelson Sauvin', amount: { value: 5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Amarillo', amount: { value: 5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Peppercorns', amount: { value: 2.5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Nelson Sauvin', amount: { value: 20, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 69, unit: 'celsius' }, duration: 105 }], fermentation: { temp: { value: 21, unit: 'celsius' } }, twist: 'Aged in whisky barrels with raspberries, tayberries and blackberries' },
  ingredients: {
    malt: [{ name: 'Extra Pale', amount: { value: 9.69, unit: 'kilograms' } }, { name: 'Chocolate', amount: { value: 0.19, unit: 'kilograms' } }, { name: 'Carafa Special Malt Type 3', amount: { value: 0.44, unit: 'kilograms' } }],
    hops: [{
      name: 'Tomahawk', amount: { value: 31.25, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Magnum', amount: { value: 12.5, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Magnum', amount: { value: 12.5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Tomahawk', amount: { value: 12.5, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      ...
      name: 'Centennial', amount: { value: 25, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Amarillo', amount: { value: 25, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Tomahawk', amount: { value: 37.5, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }],
  ...
  ingredients: {
    malt: [{ name: 'Extra Pale', amount: { value: 3.33, unit: 'kilograms' } }, { name: 'Munich', amount: { value: 0.42, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 0.28, unit: 'kilograms' } }, { name: 'Acidulated Malt', amount: { value: 0.07, unit: 'kilograms' } }],
    hops: [{
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: 105 }], fermentation: { temp: { value: 11, unit: 'celsius' } }, twist: 'Scottish Heather Honey: 62.5g at middle, Add honey during the boil. After fermentation, age in a Scottish whisky cask' },
  ingredients: {
    ...
    hops: [{
      name: 'Saaz', amount: { value: 25, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'First Gold', amount: { value: 31.3, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }],
    yeast: 'Saflager S189'
  },
  ...
  ingredients: {
    ...
    hops: [{
      name: 'Bramling Cross', amount: { value: 60, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Bramling Cross', amount: { value: 50, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 67, unit: 'celsius' }, duration: 75 }], fermentation: { temp: { value: 19, unit: 'celsius' } }, twist: 'See honey and lactose additions' },
  ingredients: {
    ...
    hops: [{
      ...
      name: 'Honey', amount: { value: 250, unit: 'grams' }, add: 'middle', attribute: 'Flavour'
    }, {
      name: 'Lactose', amount: { value: 375, unit: 'grams' }, add: 'middle', attribute: 'Flavour'
    }, {
      name: 'First Gold', amount: { value: 10, unit: 'grams' }, add: 'end', attribute: 'aroma'
    }, {
      name: 'Fuggles', amount: { value: 10, unit: 'grams' }, add: 'end', attribute: 'aroma'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  ...
  ingredients: {
    malt: [{ name: 'Pale Ale', amount: { value: 3.13, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 0.25, unit: 'kilograms' } }, { name: 'Crystal 150', amount: { value: 0.18, unit: 'kilograms' } }, { name: 'Carafa Special Malt Type 1', amount: { value: 0.25, unit: 'kilograms' } }],
    hops: [{
      name: 'Simcoe', amount: { value: 12.5, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 68, unit: 'celsius' }, duration: 50 }], fermentation: { temp: { value: 19, unit: 'celsius' } }, twist: null },
  ingredients: {
    malt: [{ name: 'Maris Otter Extra Pale', amount: { value: 3.44, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 0.63, unit: 'kilograms' } }, { name: 'Crystal 150', amount: { value: 0.31, unit: 'kilograms' } }, { name: 'Carafa Special Malt Type 1', amount: { value: 0.31, unit: 'kilograms' } }, { name: 'Carafa Special Malt Type 3', amount: { value: 0.31, unit: 'kilograms' } }],
    hops: [{
      name: 'Cascade', amount: { value: 43.8, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Cascade', amount: { value: 81.3, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      name: 'Cascade', amount: { value: 250, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: 25 }], fermentation: { temp: { value: 22, unit: 'celsius' } }, twist: null },
  ingredients: {
    malt: [{ name: 'Maris Otter Extra Pale', amount: { value: 2.5, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 1.25, unit: 'kilograms' } }, { name: 'Munich', amount: { value: 0.61, unit: 'kilograms' } }, { name: 'Crystal 150', amount: { value: 0.28, unit: 'kilograms' } }, { name: 'Dark Crystal 350-400', amount: { value: 0.2, unit: 'kilograms' } }],
    hops: [{
      name: 'Nelson Sauvin', amount: { value: 15, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Amarillo', amount: { value: 10, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      name: 'Nelson Sauvin', amount: { value: 30, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: 40 }], fermentation: { temp: { value: 21, unit: 'celsius' } }, twist: 'Barrel aged and blended with Anarchist Alchemist' },
  ingredients: {
    malt: [{ name: 'Pale Ale - Tipple', amount: { value: 11.1, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 0.94, unit: 'kilograms' } }, { name: 'Crystal', amount: { value: 0.44, unit: 'kilograms' } }],
    hops: [{
      name: 'Columbus Extract', amount: { value: 12.5, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
  ...
  food_pairing: ['Coriander & chilli crab cakes', 'Goats cheese salad with walnuts, radish and blood orange', 'Pistachio cake'],
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 68, unit: 'celsius' }, duration: 35 }], fermentation: { temp: { value: 18, unit: 'celsius' } }, twist: null },
  ingredients: {
    ...
    hops: [{
      name: 'Columbus', amount: { value: 31.25, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Columbus', amount: { value: 25, unit: 'grams' }, add: 'end', attribute: 'bitter'
    }, {
      ...
      name: 'Columbus', amount: { value: 75, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Galena', amount: { value: 75, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Simcoe', amount: { value: 100, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: 90 }], fermentation: { temp: { value: 17, unit: 'celsius' } }, twist: 'White cane sugar: 150g at middle' },
  ingredients: {
    malt: [{ name: 'Pale Ale', amount: { value: 6.13, unit: 'kilograms' } }, { name: 'Crystal 150', amount: { value: 0.25, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 0.38, unit: 'kilograms' } }, { name: 'Carafa Special Malt Type 1', amount: { value: 0.13, unit: 'kilograms' } }, { name: 'Carafa Special Malt Type 3', amount: { value: 0.13, unit: 'kilograms' } }],
    hops: [{
      name: 'Hop Extract', amount: { value: 20, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      ...
      name: 'Columbus', amount: { value: 25, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      name: 'Chinook', amount: { value: 25, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Cascade', amount: { value: 25, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Centennial', amount: { value: 25, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
  ...
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: 75 }], fermentation: { temp: { value: 19, unit: 'celsius' } }, twist: null },
  ingredients: {
    malt: [{ name: 'Extra Pale', amount: { value: 5.06, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 0.25, unit: 'kilograms' } }, { name: 'Dark Crystal', amount: { value: 0.06, unit: 'kilograms' } }],
    hops: [{
      ...
      name: 'Simcoe', amount: { value: 17.5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Simcoe', amount: { value: 17.5, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      name: 'Citra', amount: { value: 17.5, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      name: 'Simcoe', amount: { value: 75, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Cascade', amount: { value: 75, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Centennial', amount: { value: 75, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Citra', amount: { value: 25, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 66, unit: 'celsius' }, duration: 90 }], fermentation: { temp: { value: 19, unit: 'celsius' } }, twist: 'Infusion of lingonberries alongside the dry hops, Cranberry Juice: 5.5g at 30mins, Lingonberries: 10g Twist' },
  ingredients: {
    malt: [{ name: 'Extra Pale', amount: { value: 6.12, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 0.8, unit: 'kilograms' } }],
    hops: [{
      name: 'Tomahawk', amount: { value: 7, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Motueka', amount: { value: 5.5, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Galena', amount: { value: 2.5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Mt.Hood', amount: { value: 2.5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Challenger', amount: { value: 15, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Galena', amount: { value: 15, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }, {
      name: 'Nelson Sauvin', amount: { value: 20, unit: 'grams' }, add: 'dry hop', attribute: 'aroma'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  food_pairing: ['Fårikål (mutton stew) with a spicy twist', 'Fenalår (salted cured lamb)', 'Krumkake with lingonberry jam'],
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 64, unit: 'celsius' }, duration: 60 }], fermentation: { temp: { value: 21, unit: 'celsius' } }, twist: null },
  ingredients: {
    malt: [{ name: 'Extra Pale', amount: { value: 5.63, unit: 'kilograms' } }, { name: 'Wheat', amount: { value: 0.69, unit: 'kilograms' } }, { name: 'Crystal', amount: { value: 0.63, unit: 'kilograms' } }],
    hops: [{
      name: 'Columbus', amount: { value: 12.5, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Hersbrucker', amount: { value: 12.5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }],
    yeast: 'Wyeast 3333 - German Wheat™'
  },
  food_pairing: ['Grilled portabello mushroom burger', 'Chicken sausages with creamy mash', 'Caramel and banana meringue pie'],
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: 75 }], fermentation: { temp: { value: 22, unit: 'celsius' } }, twist: null },
  ingredients: {
    malt: [{ name: 'Extra Pale', amount: { value: 2.69, unit: 'kilograms' } }, { name: 'Wheat', amount: { value: 1.25, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 0.38, unit: 'kilograms' } }],
    hops: [{
      name: 'Waimea', amount: { value: 2.5, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Amarillo', amount: { value: 2.5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Nelson Sauvin', amount: { value: 2.5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Motueka', amount: { value: 2.5, unit: 'grams' }, add: 'middle', attribute: 'flavour'
    }, {
      name: 'Simcoe', amount: { value: 6, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      name: 'Citra', amount: { value: 6, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      name: 'Waimea', amount: { value: 6, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }],
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: 90 }], fermentation: { temp: { value: 19, unit: 'celsius' } }, twist: 'Part-aged in oak barrels, finished with champagne yeast' },
  ingredients: {
    malt: [{ name: 'Extra Pale', amount: { value: 10, unit: 'kilograms' } }, { name: 'Caramalt', amount: { value: 1.88, unit: 'kilograms' } }, { name: 'Munich', amount: { value: 1.25, unit: 'kilograms' } }, { name: 'Amber', amount: { value: 0.63, unit: 'kilograms' } }],
    hops: [{
      name: 'Nelson Sauvin', amount: { value: 100, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'Nelson Sauvin', amount: { value: 100, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 65, unit: 'celsius' }, duration: 75 }], fermentation: { temp: { value: 19, unit: 'celsius' } }, twist: 'Oak chips soaked in Islay whisky 50g' },
  ingredients: {
    ...
    hops: [{
      ...
      name: 'Crystal', amount: { value: 17.5, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
  ...
  volume: { value: 20, unit: 'litres' },
  boil_volume: { value: 25, unit: 'litres' },
  method: { mash_temp: [{ temp: { value: 67, unit: 'celsius' }, duration: 75 }], fermentation: { temp: { value: 19, unit: 'celsius' } }, twist: 'Crushed juniper berries: 12.5g, Lemon peel: 18.8g' },
  ingredients: {
    malt: [{ name: 'Wheat', amount: { value: 2.5, unit: 'kilograms' } }, { name: 'Extra Pale', amount: { value: 2.06, unit: 'kilograms' } }],
    hops: [{
      name: 'First Gold', amount: { value: 18.75, unit: 'grams' }, add: 'start', attribute: 'bitter'
    }, {
      name: 'First Gold', amount: { value: 25, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }, {
      name: 'Sorachi Ace', amount: { value: 16.25, unit: 'grams' }, add: 'end', attribute: 'flavour'
    }],
    yeast: 'Wyeast 1056 - American Ale™'
  },
