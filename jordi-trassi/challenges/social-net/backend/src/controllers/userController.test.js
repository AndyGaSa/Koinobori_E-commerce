...
describe('UserController', () => {
    ...
    describe('Given getOneById user', () => {
        beforeEach(() => {
            req = {
                params: { userId: '9292929292922929' },
            };
        });
        ...
        describe('When is invoked', () => {
            ...
            describe('And User.getOneById rejects', () => {
                test('Then res.status whith 500', async () => {
                    User.findById
                    .mockReturnValue({
                        populate: jest.fn().mockReturnValue({
    ...
    describe ('Given updateOneById', () => {
        beforeEach(() => {
            req = {
                body: {},
                params: { userId: 'ldkjflskjflsjdfljsdfl' },
            };
        });
        describe('When is invoked', () => {
    ...
    describe('Given deleteOneById', () => {
        beforeEach(() => {
            req = {
                body: {},
                params: { userId: 'jlkjljlkljljljkjl' },
            };
        });
        describe('When is invoked', () => {
