    ...
    getPokemons(this.pokemonsShown, this.pokemonsShown * this.pokemonsPage)
      ...
      .then((pokeArray) => {
        ...
        this.pokemonsList.forEach((pokemon) => {
          const element = `<a class="pokecontainer__card" href="../Details/details.html?pokemonId=${pokemon.id}">
          ...
          const pokemonContainer = document.querySelector('.main__nav__pokemons-container');
